...
const Resume = ({ timeline, setTimeline }) => {
  return timeline === 3 ? (
    <>
      ...
      <div className="radion-container">
        <div className="radio">
        ...
        <div className="radio">
          ...
          <label htmlFor="other-yes-res">
            J'allais dire non, mais des éléments internes au C.V d'Arthur tels
            que ses compétences et ses soft-skills m'ont poussé à changer
